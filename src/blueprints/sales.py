        ...
        if request.method == "POST":
            try:
                ...
                try:
                    ...
                    print(e)
                    flash('No está disponible algun producto seleccionado, intentelo de nuevo.', 'danger')
                ...
                if ValidarExistencia == True:
                    ...
                    try:
                        ...
                        print(e)
                        flash('Algú producto no tiene sufuciente existencia, intentelo de nuevo.', 'danger')
                        return jsonify({"message": "Error en la venta. Intente nuevamente."}), 500
